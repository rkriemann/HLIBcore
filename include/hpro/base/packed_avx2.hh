...
template <>
struct simd_traits< float, ISA_AVX2 >
{
    // SIMD base type
    using  value_t  = float;
    ...
    static packed_t  muladd     ( const packed_t  x,
                                  const packed_t  y,
                                  const packed_t  z ) { return _mm256_fmadd_ps( x, y, z ); }
    static packed_t  negmuladd  ( const packed_t  x,
                                  const packed_t  y,
                                  const packed_t  z ) { return _mm256_fnmadd_ps( x, y, z ); }
    static packed_t  mulsub     ( const packed_t  x,
                                  const packed_t  y,
                                  const packed_t  z ) { return _mm256_fmsub_ps( x, y, z ); }
    static packed_t  negmulsub  ( const packed_t  x,
                                  const packed_t  y,
                                  const packed_t  z ) { return _mm256_fnmsub_ps( x, y, z ); }
